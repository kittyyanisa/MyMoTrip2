...
class _HomeExploreSliderViewState extends State<HomeExploreSliderView> {
  ...
  void initState() {
    pageViewModelData.add(PageViewData(
      titleText: 'Phe Hee,Chiangrai',
      subText: 'Natural place \noutdoor activites',
      assetsImage: 'assets/images/phahee1.jpg',
    ));
    pageViewModelData.add(PageViewData(
      titleText: 'Find best deals',
      subText: 'Home stay \nExperience normal life',
      assetsImage: 'assets/images/doisako.jpg',
    ));
    pageViewModelData.add(PageViewData(
      titleText: 'Find Experience local Food',
      subText: 'Extraordinary local food',
      assetsImage: 'assets/images/foodd.jpg',
    ));
